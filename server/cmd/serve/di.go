...
func initializeServer(ctx context.Context, cfg config.Config, cfgFile string) (*api.Server, *sse.Broadcaster, *pipeline.PipelineOrchestrator, *histsvc.Importer, agentbroadcast.BaselineProvider, merger.Enricher, *eval.Service, func(), error) {
	...
	return server, broadcaster, orch, histImporter, baselineProvider, pipelineEnricher, evalService, cleanup, nil
}
