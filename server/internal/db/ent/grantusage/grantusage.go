...
const (
	// Label holds the string label denoting the grantusage type in the database.
	Label = "grant_usage"
	...
	FieldUsedAt = "used_at"
	// Table holds the table name of the grantusage in the database.
	Table = "grant_usages"
)

// Columns holds all SQL columns for grantusage fields.
var Columns = []string{
	FieldID,
	FieldCreatedAt,
	FieldUpdatedAt,
...
// OrderOption defines the ordering options for the GrantUsage queries.
