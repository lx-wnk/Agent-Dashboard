...
import "github.com/lx-wnk/kontor/server/internal/sse"
...
type Notifier struct{ b *sse.Broadcaster }

// NewNotifier constructs a Notifier.
func NewNotifier() *Notifier { return &Notifier{b: sse.NewBroadcaster()} }
