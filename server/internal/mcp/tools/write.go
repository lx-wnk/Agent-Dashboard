	...
	registry.Register(&mcp.ToolDef{
		...
		InputSchema: map[string]any{
			...
			"properties": map[string]any{
				...
				"autonomy":           map[string]any{"type": "string", "enum": []string{"manual", "spec_gated", "full"}, "description": "Permission gate level: manual=human-gated, spec_gated=auto-approve when covered by spec, full=allow-all"},
