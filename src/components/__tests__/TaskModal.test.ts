...
vi.mock('../AgentChatStream.vue', () => ({ default: { template: '<div />' } }))
vi.mock('../AuditLogTab.vue', () => ({ default: { template: '<div />' } }))
vi.mock('../DependencyGraph.vue', () => ({ default: { template: '<div />' } }))
vi.mock('../GitStatusPanel.vue', () => ({ default: { template: '<div />' } }))
vi.mock('../RefineStatusPanel.vue', () => ({ default: { template: '<div />' } }))
vi.mock('../StageCostWaterfall.vue', () => ({ default: { template: '<div />' } }))
vi.mock('../StageOutputView.vue', () => ({ default: { template: '<div />' } }))
vi.mock('../TaskSlashCommandMenu.vue', () => ({ default: { template: '<div />', methods: { onKeydown: () => {} } } }))
vi.mock('../WorktreeCommandRunner.vue', () => ({ default: { template: '<div />' } }))
vi.mock('../WorktreePanel.vue', () => ({ default: { template: '<div />' } }))
vi.mock('../ui/AppModal.vue', () => ({
  default: {
...
vi.mock('../ui/AppButton.vue', () => ({ default: { template: '<button><slot /></button>' } }))
vi.mock('../ui/AppInput.vue', () => ({ default: { template: '<input />' } }))
