...
<template>
  <div v-if="info" class="resource-bar">
    <div class="res-item" :title="`CPU: ${info.cpu.usage}% (${info.cpu.cores} cores)`">
      <span class="res-label">CPU</span>
      <div class="res-gauge">
        <div class="res-fill" :class="levelClass(info.cpu.usage)" :style="{ width: `${info.cpu.usage}%` }" />
      </div>
    ...
    <div class="res-item" :title="`Memory: ${fmtBytes(info.memory.used)} / ${fmtBytes(info.memory.total)}`">
      ...
      <div class="res-gauge">
        <div class="res-fill" :class="levelClass(info.memory.usagePercent)" :style="{ width: `${info.memory.usagePercent}%` }" />
      </div>
    ...
    <div class="res-item" :title="`Disk: ${fmtBytes(info.disk.used)} / ${fmtBytes(info.disk.total)}`">
      ...
      <div class="res-gauge">
        <div class="res-fill" :class="levelClass(info.disk.usagePercent)" :style="{ width: `${info.disk.usagePercent}%` }" />
      </div>
