...
<template>
  <button
    type="button"
    :disabled="disabled"
    class="inline-flex items-center justify-center font-semibold rounded-md cursor-pointer transition-all font-sans border-0 disabled:opacity-40 disabled:cursor-not-allowed"
    :class="[
