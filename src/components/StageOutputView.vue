  ...
  <div class="flex flex-col gap-3.5">
    ...
    <template v-else-if="pretty?.kind === 'pruefung'">
      <dl class="grid gap-1 text-xs mb-1" style="grid-template-columns: auto 1fr; gap: 4px 12px">
        <div class="contents">
          <dt class="text-slate-400 dark:text-slate-600 uppercase text-[10px]">Well-defined</dt>
          <dd class="text-slate-900 dark:text-slate-100">{{ pretty.wellDefined ? '✓ yes' : '✗ no' }}</dd>
        </div>
        <div class="contents">
          <dt class="text-slate-400 dark:text-slate-600 uppercase text-[10px]">Complexity</dt>
          <dd class="text-slate-900 dark:text-slate-100"><code class="font-mono text-[10px] bg-slate-100 dark:bg-slate-800 text-blue-600 dark:text-blue-400 px-1.5 py-px rounded font-semibold">{{ pretty.complexity }}</code></dd>
        </div>
        <div class="contents">
          <dt class="text-slate-400 dark:text-slate-600 uppercase text-[10px]">Recommendation</dt>
          <dd class="text-slate-900 dark:text-slate-100"><code class="font-mono text-[10px] bg-slate-100 dark:bg-slate-800 text-blue-600 dark:text-blue-400 px-1.5 py-px rounded font-semibold">{{ pretty.recommendation }}</code></dd>
        </div>
      </dl>
    ...
    <template v-else-if="pretty?.kind === 'selbstreview'">
      <dl class="grid gap-1 text-xs mb-1" style="grid-template-columns: auto 1fr; gap: 4px 12px">
        <div class="contents">
          <dt class="text-slate-400 dark:text-slate-600 uppercase text-[10px]">Passed</dt>
    ...
    <details v-else>
      <summary class="cursor-pointer text-slate-400 dark:text-slate-600 text-[11px]">Raw output</summary>
